---
title: 'How to correctly group data by month with BigQuery'
date: '2023-04-07'
...
Here's how the query should like if you want to aggregate by month using the Mnth Year format (ie: `Apr 2023`):
...
And if you want to aggregate by month using the Month Year format (ie: `April 2023`):
